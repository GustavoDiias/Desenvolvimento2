...
const Tab = createMaterialTopTabNavigator({
  ...
  Pasta1: {
    ...
    navigationOptions: () => ({
      ...
      tabBarIcon: ({ focused }) => (
        <Icon name="file-code-o" size={15} color={focused === true ? Colors.white : Colors.whiteTransparent} />
      ),
  ...
  Pasta2: {
    ...
    navigationOptions: () => ({
      tabBarIcon: ({ focused }) => (
        <Icon name="hand-pointer-o" color={focused === true ? Colors.white : Colors.whiteTransparent} />
      ),
  ...
  Pasta3: {
    ...
    navigationOptions: () => ({
      tabBarIcon: ({ focused }) => (
        <Icon name="vcard-o" size={15} color={focused === true ? Colors.white : Colors.whiteTransparent} />
      ),
    })
  },
  },
...
const ConfiguracaoPage = createStackNavigator({
  First: {
    screen: Configuracao,
    navigationOptions: ({ navigation }) => ({
      title: 'Configuração',
