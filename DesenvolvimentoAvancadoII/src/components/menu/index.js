  ...
  return (
    <View style={Styles.container}>
      ...
      <View
          style={[
            Styles.screenStyle,
            activeItemKey == 'CadastroImoveis' ? Styles.activeBackgroundColor : null,
          ]}>
          <Icon name="university" style={Styles.icone} />
          <Text
            style={[
              Styles.screenTextStyle,
              activeItemKey == 'CadastroImoveis' ? Styles.selectedTextStyle : null,
            ]}
            onPress={() => navigateToScreen('CadastroImoveis')}>
            Imoveis
          </Text>
        </View>
        <View
