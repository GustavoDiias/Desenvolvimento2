    ...
    return (
        <View style={Styles.container}>
            ...
            <View style={Styles.screenContainer}>
                ...
                <View style={[Styles.screenStyle, (activeItemKey == 'Configuracao') ? Styles.activeBackgroundColor : null]}>
                    <Icon name="cogs" style={Styles.icone} />
                    <Text style={[Styles.screenTextStyle, (activeItemKey == 'Configuracao') ? Styles.selectedTextStyle : null]} onPress={() => navigateToScreen('Configuracao')}>Configuração</Text>
                </View>
